...
\title[NE529 -- Risk Assessment]{NE529\\RISK ASSESSMENT\\Introduction to the course\\0}
...
\begin{frame}{What is this course about?}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item What is risk assessment?
        \item What kind of work is done?
        \item Where is risk assessment applied?
        \item[]Understanding the risk paradigm
...
\begin{frame}{What to get out of the course}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item[]Understanding risk assessment tools
        \item[]Developing skills to implement them – scientific computing, critical thinking, writing
        \item[]Interpreting risk perception
        \item[]Critiquing constraints of risk assessment
        \item[]Gaining engineering judgement
...
\begin{frame}{Workload}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        ...
        \item[]Email homework as pdf to \textit{gmail address} with NE529 in the subject title  
    \end{enumerate}
\end{frame}
...
\begin{frame}{Textbook suggestions}
    ...
    \item Guidelines for Hazard Evaluation Procedures, 3rd Edition. Center for Chemical Process Safety, 978-0-471-97815-2 (2008). 
        \item[]Loosely based on the first book
...
\begin{frame}{Prerequisites}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=15pt,leftmargin=*,label=(\arabic*)]
        ...
        \item[]Some math is needed
        \item[]Being able to describe phenomena with math is important skill in research 
        \item[]Largely qualitative, but there is a lot of good analysis that can be derived from these tools
    \end{enumerate}
\end{frame}
...
\begin{frame}{Learning modules}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=11pt,leftmargin=*,label=(\arabic*)]
        ...
        \item\acf{pha}
        \item\acf{fma}
        \item Fault \& event trees
        \item Risk management
        \item\acf{hra}
        \item\acf{pra}
        \item Maybe cybersecurity
        \item[]Guest lecturers -- taking suggestions -- post ideas on piazza
    \end{enumerate}
\end{frame}
