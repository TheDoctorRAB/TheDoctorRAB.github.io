...
\section{\acs{haz} I}
\paragraph*{(100)}
Since there have been several \acsp{pha} and \acsp{fma} conducted already, continue your risk assessment and perform a limited \acs{haz} on one of the systems of interest or something new. Perform the \acs{haz} for a total of 6 deviations; e.g., a single component, 2 parameters with 3 guidewords; 3 parameters with 2 guidewords, or a similar combination for 2 components. Construct a \acs{haz} table and sufficiently explain your reasoning.
...
\section{\acs{haz} II}
\paragraph*{(100)}
You are driving on I-84, west of Twin Falls, heading to Boise for some ridiculous symposium. It is nighttime and late in March. Conduct a \acs{haz} for the commute (i.e., operation of the car) as follows and sufficiently explain your reasoning.
\begin{itemize}[leftmargin=*,topsep=-1ex,itemsep=-1ex,partopsep=1ex,parsep=1ex,font=\bfseries]
    ...
    \item Again, select a combination of 6 deviations and complete the \acs{haz} table.
\end{itemize}
