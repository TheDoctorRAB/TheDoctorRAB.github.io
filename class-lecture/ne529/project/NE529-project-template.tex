...
\usepackage{chngcntr}
\counterwithin*{section}{part} %restart section under part
%%%%%
...
\titleformat{\part}{\normalfont\Large\bfseries\filcenter}{Phase \thepart }{0ex}{ - }[]
...
\lhead{\scriptsize NE529 final report}
\chead{\scriptsize \textit{Abbrev Title}}
...
\section*{Executive Summary} \label{sec-exec-summ} 
