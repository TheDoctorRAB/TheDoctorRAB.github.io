...
\paragraph*{(30)}
Put all the results from the reflector problems together in a table. Which reflector material is minimal and why, neutronically speaking? Check the output files for different types of neutron losses as part of the analysis. 
