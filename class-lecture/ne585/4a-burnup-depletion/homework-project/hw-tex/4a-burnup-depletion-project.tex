...
\chead{\scriptsize \textit{Project 4a -- Burnup \& Depletion}}
...
\section{Plutonium production -- (100)}
Solve the Pu-239 production equation. See \cref{app-equations} and \Cref{tab-data} for guidance.
...
\section{Fission product production I -- (100)}
...
\section{Burnup -- (100)}
Plot $N v B$ for U-235, U-238, Pu-239, and the fission products all together. Compare to Fig. 3.29 from Benedict in \cref{app-burnup}. Don't worry that the graph is B v w; the shape of the curves should be similar. 
...
\section{Fission product production II -- (100)}
...
\begin{longtable}{|c|c|}
    ...
    \hline
    $\overline{\phi}$
    &$3.5 \times 10^{13} \; \frac{n}{cm^2 \cdot s}$
    \\
    \hline
    $\epsilon$
    &1.0476
...
%%%%%
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \\
            w &= \frac{235N^F_{25} + 238N^F_{28} + 239N^F_{49} + 241N^F_{41}}{235N^0_{25} +  238N^0_{28}}
        \end{aligned}
    \end{equation}
...
\newpage
    ...
    \section{Burnup graph} \label{app-burnup}
    \includepdf[scale=1.00,pages=-]{$TEXIMG/class/ne585/burnup.pdf}
