...
\section{WASH-1400}
\paragraph*{(100)}
Assuming formalized \acs{pra} started with WASH-1400, and given the all the case studies we have discussed in class, has its use as an assessment tool sufficiently advanced with technological developments? Does \acs{pra} truly capture risk adequately? What is missing? What can be improved? Critically discuss the use and role of \acs{pra} to assess risk.
