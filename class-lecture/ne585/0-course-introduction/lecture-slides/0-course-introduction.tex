...
\title[NE585 - Nuclear fuel cycles]{NE585\\NUCLEAR FUEL CYCLES\\Introduction to the course\\0}
...
\begin{frame}{What is this course about?}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item What is nuclear engineering?
        \item What kind of work is done?
        \item[]NE585 sets the table for success in the nuclear engineering department at the University of Idaho
        \item[]The course is research driven and focused on developing \textit{transferable skills}
        \item[]\textit{Research is a higher level of learning}
    \end{enumerate}
\end{frame}


\begin{frame}{Social media and online content}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=1pt,leftmargin=*,label=(\arabic*)]
        \item[]\textbf{Twitter}
        \item[]\href{http://twitter.com/TheDoctorRAB}{@TheDoctorRAB}
            \vspace{0.15in}
        \item[]\textbf{GitHub}
        \item[]\href{https://github.com/TheDoctorRAB}{TheDoctorRAB}
    \end{enumerate}
\end{frame}


\begin{frame}{What to get out of the course}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item[]Understanding nuclear engineering problems
        \item[]Developing skills to solve them -- scientific computing, critical thinking, \acs{mcp}, writing
        \item[]You're adults. You get what you put in
    \end{enumerate}
\end{frame}
...
\begin{frame}{Workload}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item[]Three credit course
        \item[]How much time will you put in (average) each week?
        \item[]Assignments usually require outside research
        \item[]Collaboration is encouraged because that is what happens in the real world
        \item[]Everyone hands in their own assignments though
        \item[]Email homework as pdf to \textit{gmail address} with NE585 in the subject title  
    \end{enumerate}
\end{frame}


\begin{frame}{Textbook suggestions}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=15pt,leftmargin=*,label=(\arabic*)]
        \item[]Introduction to nuclear engineering, John R. Lamarsh, ISBN 0-201-14200-7 (1983)
        ...
        \item[]NE585 is based on Lamarsh
        \item[]Any edition is ok -- try not to spend too much
        \item[]Other textbooks are just for additional reference
        \item[]No specific reading assignments but it's expected you're reasonably prepared for each class period
    \end{enumerate}
\end{frame}


\begin{frame}{Pedagogical approach}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item[]Context based learning
        \item[]That means `student-driven'
        \item[]Talking at you isn't the best use of our time
        \item[]Homework presentations for each class
        \item[]Regular participation is expected
    \end{enumerate}
\end{frame}
...
\begin{frame}{Class management}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item[]\href{https://piazza.com/uidaho/fall2023/ne585}{Piazza} will contain all the course materials
        \item[]We also use this for discussion outside of class
        \item[]Still trying to convert to Canvas
        \item[]This is a very good platform for a nontraditional student body
        \item[]Don't email class questions
        \item[]Someone else might have the same question
        \item[]Someone else might have a better answer than me
    \end{enumerate}
\end{frame}
...
\begin{frame}{\acs{mcp}}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=15pt,leftmargin=*,label=(\arabic*)]
        \item[]\acs{mcp} is a WIDELY used computational tool in nuclear engineering for literally anything you can think of
        \item[]Our goal is to gain \href{https://raw.githubusercontent.com/TheDoctorRAB/igem/master/neutronics-shielding/high-burnup/H-5060/guide-assembly/bare/air/air-backfill/50wt/30wt/12cm/inp/single.assembly_7815.inp}{facility} with \href{https://piazza.com/class_profile/get_resource/kr0va8w7fkb32r/kr0vac8etb536z}{it}
        \item[]Many many many students who have learned it in NE585 have leveraged that for internships
        \item[]It's free, but export controlled
        \item[]Please go to \href{https://rsicc.ornl.gov/}{RSICC} and request \acs{mcp}6.2
        \item[]You need to register for an account, and they use that for your license
        \item[]\acs{doe} or \acs{inl} may be different 
    \end{enumerate}
\end{frame}
...
\begin{frame}{Prerequisites}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=15pt,leftmargin=*,label=(\arabic*)]
        \item[]Assumed you've had most engineering courses (linear algebra, statics, etc.)
        \item[]I am not teaching these subjects
        \item[]Differential equations - just Laplace transform and standard models
        \item[]Learn a real graphing program -- \textbf{NO EXCEL GRAPHS}
        \item[]VLab has some software 
        \item[]Or use my python routine on my \href{https://github.com/TheDoctorRAB/plot.git}{github}
        \item[]Math is going to be done 
        \item[]Being able to describe phenomena with math is important skill in research.  
    \end{enumerate}
\end{frame}


\begin{frame}{Learning modules}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=21pt,leftmargin=*,label=(\arabic*)]
        \item Fundamental nuclear physics
        \item Interaction of radiation with matter
        \item Nuclear fuel cycle analysis
        \item\textbf{Nuclear reactor theory}
        \item\textbf{Monte Carlo methods and \acs{mcp}}
        \item[]The challenge is when/how to kick off \acs{mcp}
    \end{enumerate}
\end{frame}


\begin{frame}{Aristotle also had something to say about engineering education}
    \begin{enumerate}[series=outerlist,topsep=0pt,itemsep=1pt,leftmargin=*,label=(\arabic*)]
        \item[]\textbf{Techne}
        \item[]Human skill based on a set of principles derived from practices and capable of being taught
            \vspace{0.15in}
        \item[]\textbf{Epistme}
        \item[]Knowledge, which consists of knowing why or knowing that
            \vspace{0.15in}
        \item[]\textbf{Praxis}
        \item[]The end of which is realized in the very doing of the activity
            \vspace{0.15in}
        \item[]\textbf{Phronesis}
        \item[]Practical wisdom
    \end{enumerate}
\end{frame}
