...
\chead{\scriptsize \textit{Project 2 -- Nuclear engineering basics}}
...
\section{Maxima and minima energies -- (10)}
...
\section{Fractional energy loss limit -- (10)}
...
\section{Lethargy functional behavior -- (10)}
...
\section{Lethargy derivation -- (20)}
Derive $\xi$. Apply the definition of \href{https://uidaho.pressbooks.pub/riskassessment/chapter/statistical-moments/}{expected value for a continuous random variable derivation} and the probability distribution per unit energy loss. \textit{The probability distribution can just be looked up and not derived, but please explain the functional behavior.}
...
\section{Materials functional behavior on collisions -- (10)}
...
\section{Inelastic scattering -- (10)}
...
\section{Materials for neutron capture -- (15)}
...
\section{Maxwell - Most probable energy and velocity -- (25)}
...
\section{Maxwell - Mean energy and velocity -- (25)}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth,alt={concrete wall shielding}]{class/ne585/hw2-15a.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth,alt={concrete wall shielding with lead lining}]{class/ne585/hw2-15b.jpg}
