...
\section{Evaluating an integral I -- (30)}
...
\section{Evaluating an integral II -- (30)}
...
\section{Hot cell modeling -- (50)}
Conduct a short modeling study of the metal fuel alloy for the hot cell facility using - 
\begin{itemize}
    \item\href{https://github.com/TheDoctorRAB/mcnpx.decks/blob/master/neutron.flux/input/4_ff.alloy.inp}{4\_ff.alloy.inp (flux) code on github}
    \item\href{https://github.com/TheDoctorRAB/mcnpx.decks/blob/master/neutron.flux/input/4d_ff.alloy.inp}{4d\_ff.alloy.inp (dose) code on github}
\end{itemize}

See also the related \href{https://www.sciencedirect.com/science/article/abs/pii/S0029549316301066}{journal paper on hot cell shielding} for more information. 
...
\textit{Is this wall thickness reasonable? As in, could a facility be practically built like this using current engineering design techniques?}

\textit{Include the MCNP file at the end in an appendix.}
...
For the subsequent criticality models, to get full credit -- 
\begin{enumerate}
...
\textbf{PROTIP -- }k can vary weird when your trying to get the critical radius to 4 or 5 decimal places. Study the KCODE parameters. You could also add more particles on KSRC, but be careful where you place them.

\newpage

\section{Critical mass I -- (20)}
What is the critical mass of a bare sphere of plutonium
\begin{enumerate}
    \item$95.5\% \; ^{239}Pu$ and 
    \item$80\% \; ^{239}Pu$.
\end{enumerate}
The rest is $^{238}Pu$.
...
\section{Critical mass with reflector -- (20)}
...
Reproduce the model to get the result. See the \href{https://piazza.com/class_profile/get_resource/mcf5xaxnhxh5qs/mgqps3ida2r4d}{MCNP neutron benchmark problems report} for guidance.
