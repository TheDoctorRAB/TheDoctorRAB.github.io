...
\begin{enumerate}[series=outerlist,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textbf{Workscope \arabic* --},align=left]
    \item\textbf{.} 
        \begin{enumerate}[series=innerlist,topsep=3pt,itemsep=1.5ex,partopsep=1ex,parsep=-1ex,label=\textit{Task \Roman*.},labelsep=2.5ex,align=left]
            \item\textit{.}
            \item\textit{.}
        \end{enumerate}
\end{enumerate}

\begin{enumerate}[series=milestone,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textbf{\textit{Milestone \arabic*.}},align=left]
    \item\textit{.}
\end{enumerate}


\begin{enumerate}[resume=outerlist,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textbf{Workscope \arabic* --},align=left]
    \item\textbf{.}
        \begin{enumerate}[resume=innerlist,topsep=3pt,itemsep=1.5ex,partopsep=1ex,parsep=-1ex,label=\textit{Task \Roman*.},labelsep=2.5ex,align=left]
            \item\textit{.}
...
\begin{enumerate}[resume=milestone,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textbf{\textit{Milestone \arabic*.}},align=left]
    \item\textit{.}
\end{enumerate}
