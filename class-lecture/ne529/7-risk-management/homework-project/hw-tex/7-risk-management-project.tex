...
\begin{itemize}[leftmargin=*,topsep=0ex,itemsep=0ex,partopsep=1ex,parsep=1ex,font=\bfseries]
...
\paragraph*{(50)}
It is impossibly difficult to predict earthquakes. However, expert geologists confirm that 1 high-magnitude earthquake will occur in 150 years. Does your decision change? (Explain, obviously.)
